...
@section('title', '| Monthly Overall Report')

@section('breadcrumb', 'Monthly Overall Report')
...
<div class="row layout-top-spacing">
    <div class="col-xl-12 col-lg-12 col-sm-12">
        <div class="widget-content widget-content-area br-4">
            <div class="col-12">
                <h5 style="display: inline;">Monthly Overall Report</h5>
            ...
            <div class="reportActionBtn mt-2 text-center">
                ...
                <a href="{{ route('employer.company.monthlyOverAllReport',$companyCandidate->company_id)}}" class="btn active">Monthly</a>
