...
@section('title', '| Daily Overall Report')

@section('breadcrumb', 'Daily Overall Report')
    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="widget-content widget-content-area br-4">
                <div class="col-12">
                    <h5 style="display: inline;">Daily Overall Report</h5>
                ...
                <div class="reportActionBtn mt-2 text-center">
                    <a href="{{ route('employer.company.dailyOverAllReport',$companyCandidate->company_id)}}" class="btn active">Daily</a>
                    ...
                    <a href="{{ route('employer.company.yearlyOverAllReport',$companyCandidate->company_id)}}" class="btn">Yearly</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="circle-wrap firstPercentage">
                            <div class="circle">
                                ...
                                <div class="inside-circle d-flex justify-content-center">
                                    <span class="count">{{ $presentPercentage ?? 0 }}</span><span>%</span>
