...
@section('title', '| Weekly Overall Report')

@section('breadcrumb', 'Weekly Overall Report')
...
<div class="row layout-top-spacing">
    <div class="col-xl-12 col-lg-12 col-sm-12">
        <div class="widget-content widget-content-area br-4">
            <div class="col-12">
                <h5 style="display: inline;">Weekly Overall Report</h5>
            ...
            <div class="reportActionBtn mt-2 text-center">
                ...
                <a href="{{ route('employer.company.weeklyOverAllReport',$companyCandidate->company_id)}}" class="btn active">Weekly</a>
