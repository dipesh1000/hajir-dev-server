<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {{-- <div class="custom-control custom-radio custom-control-inline">
                ...
                value="calendar_days" {{ ((isset($company) ? $company->calculation_type:'')|| old('calculation_type')) == "calendar_days" ? 'checked' : ''}}>
            ...
            <div class="custom-control custom-radio custom-control-inline">
                ...
                value="30_days" {{ ((isset($company) ? $company->calculation_type:'') || old('calculation_type')) == "30_days" ? 'checked' : 'checked'}}>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="government_leavedates">Government Holiday</label><br>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="special_leavedates">Offical Holiday</label><br>
    ...
    <div class="col-md-4">
        <label for="leave_duration_type">Sick Leave Allowed</label><br>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="probation_period">Probation Period (Month)</label><br>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input class="form-control" type="number" min="0" max="24" name="office_hour" id="office_hour" placeholder="eg:8"
             value="{{ $company->office_hour ?? old('office_hour')}}" required>
            @error('office_hour')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
