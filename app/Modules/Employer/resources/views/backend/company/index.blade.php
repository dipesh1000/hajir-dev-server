        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="widget-content widget-content-area br-6">
                <div class="col-12 d-flex justify-content-between">
                    ...
                    <div class="d-flex">
                        <a class="btn btn-secondary mr-2 pl-3 pr-3" href="{{ route('employer.company.index').'?type=Active'}}">Active</a>
                        <a class="btn btn-secondary  mr-2 pl-3 pr-3 " href="{{ route('employer.company.index').'?type=Inactive'}}">Inactive</a>
                    </div>
                    <a class="btn btn-primary float-right " href="{{ route('employer.company.create')}}">Add New</a>
                </div>
                <hr class="mb-0">
