...
class CompanyCandidateAllResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [    
            ...
            'name' => $this->candidate->name ?? $this->name,
            'phone' => $this->candidate->phone,
            'email' => $this->candidate->email,
            'dob' => $this->candidate->dob != null ? $this->candidate->dob->format('Y-m-d') : '',
            'joining_date' =>$this->joining_date!= null ? $this->joining_date->format('Y-m-d') : '',
